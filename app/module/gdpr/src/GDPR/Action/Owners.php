...
use GDPR\Entity\Config\User;
use GDPR\Entity\Privacy\Domain;
use GDPR\Entity\Privacy\Operator;
use GDPR\Entity\Proxy\OwnerProxy;
use GDPR\Resource\DomainResource;
use GDPR\Resource\OperatorResource;
use GDPR\Resource\OwnerResource;
use GDPR\Resource\UserExistException;
use GDPR\Resource\UserResource;
...
use GDPR\Resource\CompanyExistException;
use GDPR\Resource\EmailExistException;
