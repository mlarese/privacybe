...
use GDPR\Entity\Config\OwnerRepository;

use GDPR\Entity\Privacy\MailUpListTTL;
use GDPR\Helpers\DynDb;
use GDPR\Helpers\MailOneCustomForm;
use GDPR\Service\MailOneService;
use GDPR\Service\MailUpService;
...
class MailUpDirectExport  implements IDirectExport
{
    ...
    private function checkConfig(){
        ...
        try{
            $this->mailUpConfig = $this->em->getRepository(\GDPR\Entity\Privacy\Configuration::class)->findBy(array('code' => 'mailup'));
        }
        catch(\Exception $e){
            print_r($e->getMessage());
            die;
