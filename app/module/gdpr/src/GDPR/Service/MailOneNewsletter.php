...
use GDPR\Entity\Upgrade\SubscriberDomainPath;
use GDPR\Resource\MailOneDirectExport;
...
class MailOneNewsletter {
    ...
    public function import (
        ...
        if($conn->isConnected())
        {
            ...
            $term = $privacy->getRepository('GDPR\Entity\Privacy\Term')->findOneByUid($termId);
            ...
            foreach ($listId as $singleId)
            {
                ...
                if($result && !empty($result))
                {
                    ...
                    foreach ($result as $newsletteretails)
                    {
                        ...
                        $checkEmailExists = $privacy->getRepository('GDPR\Entity\Privacy\Privacy')->findByEmail($email);
