 ...
 * cookie
 */
$cfg['blowfish_secret'] = 'Ivp20SUj3nF2IOYSntZM7xZYWmBmAQfd'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
...
$i++;
$cfg['Servers'][$i]['host']          = 'dataone_mariadb'; // MySQL hostname or IP address
